...
export type ActivityFiltersCragQuery = { __typename?: 'Query' } & {
  crag: { __typename?: 'Crag' } & Pick<Crag, 'id' | 'name'>;
};
...
export type ActivityFiltersRouteQuery = { __typename?: 'Query' } & {
  route: { __typename?: 'Route' } & Pick<Route, 'id' | 'name'>;
};
...
export type CreateActivityMutation = { __typename?: 'Mutation' } & {
  createActivity: { __typename?: 'Activity' } & Pick<Activity, 'id'>;
};
...
export type MyActivitiesQuery = { __typename?: 'Query' } & {
  myActivities: { __typename?: 'PaginatedActivities' } & {
    items: Array<
      { __typename?: 'Activity' } & Pick<Activity, 'name' | 'date' | 'type'> & {
          routes: Array<
            { __typename?: 'ActivityRoute' } & Pick<ActivityRoute, 'grade'>
          >;
          crag?: Maybe<
            { __typename?: 'Crag' } & Pick<Crag, 'id' | 'name' | 'slug'> & {
                country: { __typename?: 'Country' } & Pick<Country, 'slug'>;
              }
          >;
        }
    >;
...
export type MyActivityRoutesQuery = { __typename?: 'Query' } & {
  myActivityRoutes: { __typename?: 'PaginatedActivityRoutes' } & {
    items: Array<
      { __typename?: 'ActivityRoute' } & Pick<
        ActivityRoute,
        | 'difficulty'
        | 'date'
        | 'ascentType'
        ...
        | 'publish'
      > & {
          route: { __typename?: 'Route' } & Pick<Route, 'name' | 'id'> & {
              crag: { __typename?: 'Crag' } & Pick<
                Crag,
                'id' | 'name' | 'slug'
              > & {
                  country: { __typename?: 'Country' } & Pick<Country, 'slug'>;
...
export type ProfileQuery = { __typename?: 'Query' } & {
  profile: { __typename?: 'User' } & Pick<User, 'id' | 'email' | 'roles'>;
};
...
export type CreateClubMemberByEmailMutation = { __typename?: 'Mutation' } & {
  createClubMemberByEmail: { __typename?: 'ClubMember' } & Pick<
    ClubMember,
    'id'
  >;
};
...
export type ActivityRoutesByClubQuery = { __typename?: 'Query' } & {
  activityRoutesByClub: { __typename?: 'PaginatedActivityRoutes' } & {
    items: Array<
      { __typename?: 'ActivityRoute' } & Pick<
        ActivityRoute,
        | 'date'
...
export type ClubByIdQuery = { __typename?: 'Query' } & {
  club: { __typename?: 'Club' } & Pick<Club, 'id' | 'name'> & {
      members: Array<
        { __typename?: 'ClubMember' } & Pick<ClubMember, 'admin'> & {
            user: { __typename?: 'User' } & Pick<User, 'id' | 'fullName'>;
          }
      >;
    };
...
export type MyClubsQuery = { __typename?: 'Query' } & {
  myClubs: Array<
    { __typename?: 'Club' } & Pick<Club, 'id' | 'name' | 'nrMembers'>
  >;
};
...
export type UserFullNameQuery = { __typename?: 'Query' } & {
...
export type UpdateCommentMutation = { __typename?: 'Mutation' } & {
  updateComment: { __typename?: 'Comment' } & Pick<Comment, 'id' | 'content'>;
};

export type CountriesTocQueryVariables = Exact<{ [key: string]: never }>;

export type CountriesTocQuery = { __typename?: 'Query' } & {
  countries: Array<
    { __typename?: 'Country' } & Pick<Country, 'name' | 'slug' | 'nrCrags'>
  >;
};
...
export type CragBySlugQuery = { __typename?: 'Query' } & {
  cragBySlug: { __typename?: 'Crag' } & Pick<
    Crag,
    'id' | 'slug' | 'name' | 'lat' | 'lon' | 'access' | 'description'
  > & {
      area?: Maybe<{ __typename?: 'Area' } & Pick<Area, 'id' | 'name'>>;
      country: { __typename?: 'Country' } & Pick<
        Country,
        'id' | 'name' | 'slug'
      >;
      sectors: Array<
        { __typename?: 'Sector' } & Pick<Sector, 'id' | 'name' | 'label'> & {
            routes: Array<
              { __typename?: 'Route' } & Pick<
                Route,
                'id' | 'name' | 'grade' | 'length'
              >
            >;
          }
      >;
      ...
      >;
      images: Array<
        { __typename?: 'Image' } & Pick<Image, 'id' | 'title' | 'path'>
      >;
    };
};
...
export type CragsQuery = { __typename?: 'Query' } & {
  countryBySlug: { __typename?: 'Country' } & Pick<
    Country,
    'id' | 'name' | 'slug' | 'code'
  > & {
      crags: Array<
        { __typename?: 'Crag' } & Pick<
          Crag,
          | 'id'
          | 'slug'
          | 'name'
      ...
      >;
      areas: Array<{ __typename?: 'Area' } & Pick<Area, 'id' | 'name'>>;
    };
};
...
export class ActivityFiltersCragGQL extends Apollo.Query<
  ActivityFiltersCragQuery,
  ActivityFiltersCragQueryVariables
> {
...
export class ActivityFiltersRouteGQL extends Apollo.Query<
  ActivityFiltersRouteQuery,
  ActivityFiltersRouteQueryVariables
> {
...
export class CreateActivityGQL extends Apollo.Mutation<
...
export class MyActivitiesGQL extends Apollo.Query<
  MyActivitiesQuery,
...
export class MyActivityRoutesGQL extends Apollo.Query<
...
export class CreateClubMemberByEmailGQL extends Apollo.Mutation<
  CreateClubMemberByEmailMutation,
  CreateClubMemberByEmailMutationVariables
> {
...
export class ActivityRoutesByClubGQL extends Apollo.Query<
  ActivityRoutesByClubQuery,
  ActivityRoutesByClubQueryVariables
> {
...
export class ClubByIdGQL extends Apollo.Query<
  ClubByIdQuery,
  ClubByIdQueryVariables
> {
...
export class MyClubsGQL extends Apollo.Query<
  MyClubsQuery,
...
export class UserFullNameGQL extends Apollo.Query<
  UserFullNameQuery,
  UserFullNameQueryVariables
> {
...
export const CountriesTocDocument = gql`
  query CountriesToc {
    countries(
      input: {
        hasCrags: true
        orderBy: { field: "nrCrags", direction: "DESC" }
      }
    ) {
      name
      slug
...
export class CountriesTocGQL extends Apollo.Query<
  CountriesTocQuery,
  CountriesTocQueryVariables
> {
...
export class CragBySlugGQL extends Apollo.Query<
  CragBySlugQuery,
  CragBySlugQueryVariables
> {
